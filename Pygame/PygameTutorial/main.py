...
def yellow_handle_movement(keys_press, yellow):
    if keys_press[pygame.K_w] and yellow.y - VEL > 0: # UP
        yellow.y -= VEL
    if keys_press[pygame.K_a] and yellow.x - VEL > 0: # LEFT
        yellow.x -= VEL
    if keys_press[pygame.K_s] and yellow.y + VEL < 550: # DOWN
        yellow.y += VEL
    if keys_press[pygame.K_d] and yellow.x + VEL < 365: # RIGHT
        yellow.x += VEL

def red_handle_movement(keys_press, red):
    if keys_press[pygame.K_UP] and red.y - VEL > 0: # UP
        red.y -= VEL
    if keys_press[pygame.K_LEFT] and red.x - VEL > 400: # LEFT
        red.x -= VEL
    if keys_press[pygame.K_DOWN] and red.y + VEL < 550: # DOWN
        red.y += VEL
    if keys_press[pygame.K_RIGHT] and red.x + VEL < 760: # RIGHT
        red.x += VEL
...
def main():
    ...
    while run:
        ...
        yellow_handle_movement(keys_press, yellow)
